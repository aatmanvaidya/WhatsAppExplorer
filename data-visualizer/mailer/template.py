...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  ...
  <body>
    <div>
                        ...
                        <div class='dys-column-per-100 outlook-group-fix' style='direction:ltr;display:inline-block;font-size:13px;text-align:left;vertical-align:top;width:100%;'>
                          <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='vertical-align:top;' width='100%'>
                            ...
                            <tr>
                              <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                                <div style='color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:21px;text-align:center;'>
                                Welcome to our weekly digest, featuring the top three trending messages, photos, and links from the past week. Our expert curators have compiled the most engaging content for your convenience. Sit back, relax, and enjoy a glimpse into the world around you.
                                </div>
                              </td>
                            </tr>
                          </table>
      ...
      <div style='margin:0px auto;max-width:600px;margin-bottom:30px;'>
        <table align='center' border='0' cellpadding='0' cellspacing='0' role='presentation' style='width:100%;'>
          <tbody>
            <tr>
              <td style='direction:ltr;font-size:0px;padding:20px 0;padding-bottom:0px;text-align:center;vertical-align:top;'>
    ...
    <table align='center' border='0' cellpadding='0' cellspacing='0' role='presentation' style='background:#f7f7f7;background-color:#f7f7f7;width:100%;'>
      ...
      <div style='margin:0px auto;max-width:600px;background-color:#f7f7f7;'>
        <table align='center' border='0' cellpadding='0' cellspacing='0' role='presentation' style='width:100%;'>
          <tbody>
            <tr>
              <td style='direction:ltr;font-size:0px;padding:20px 0;text-align:center;vertical-align:top;'>
                <a href="https://analysis.whats-viral.me/" target="_blank" style="font-size: 16px; background: #ff6f6f; color: white; padding: 10px 30px; border-radius: 10px; text-decoration: none;">Go to Dashboard</a>
              </td>
            </tr>
          </tbody>
        </table>
