...
def whatsapp():
    ...
    directory_path = '/mnt/storage/kg766/WhatsappMonitorData/data/'
    ...
    # latest_modified_directory = "060923"
    print('/mnt/storage/kg766/WhatsappMonitorData/data/{}/messages.json'.format(latest_modified_directory))
    # cnt = 0
    # for messages_path in glob.iglob('../../whatsappMonitor/data/*/messages.json', recursive=True):
    for messages_path in glob.iglob('/mnt/storage/kg766/WhatsappMonitorData/data/{}/messages.json'.format(latest_modified_directory), recursive=True):
        print(messages_path)
        # cnt+=1
        # if cnt > 2:
        #     break
