...
def mailer(platform, section, dateMin, dateMax):
    ...
    response_json = response.json()
    # print(response_json)
    images_html = "".join([f'<img src="https://analysis-backend.whats-viral.me/{platform}/{data["content"]}" width="200px" height="200px"/>' for data in response_json])
...
mailer(platform="whatsapp", section="test", dateMin="03-17-2023", dateMax="03-23-2023")
# mailer(platform="whatsapp", section=["test"], dateMin="12-24-2022", dateMax="02-12-2023")