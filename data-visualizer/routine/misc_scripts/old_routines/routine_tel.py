...
def telegram():
    ...
    #                 continue
                ...
                metadata = {
                    ...
                    "chatname": messages_row["peer_id"]["channel_id"],
                    "section": "test",
                }
    ...
    messages_map = {}
    num_clusters, cluster_messages = get_clusters(messages_list, 10000)
    ...
    # run_command('mongo {} --eval "db.tel_links.drop()"'.format(database))
    # run_command('mongo {} --eval "db.tel_messages.drop()"'.format(database))
    # run_command('mongo {} --eval "db.tel_images.drop()"'.format(database))
